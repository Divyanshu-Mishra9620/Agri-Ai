...
export const CommunityChannel = mongoose.model('CommunityChannel', channelSchema);
...
export const CommunityAnalytics = mongoose.model('CommunityAnalytics', communityAnalyticsSchema);