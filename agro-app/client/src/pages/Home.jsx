...
export default function Home() {
  ...
  const tech = [
    ...
    { icon: '📡', title: t('home_realtime_title'), desc: t('home_realtime_desc') },
  ...
  return (
    <div className="max-w-7xl mx-auto relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-2 h-2 bg-green-400 rounded-full animate-bounce opacity-60" style={{ animationDelay: '0s', animationDuration: '3s' }} />
        <div className="absolute top-40 right-20 w-1 h-1 bg-blue-400 rounded-full animate-bounce opacity-50" style={{ animationDelay: '1s', animationDuration: '4s' }} />
        <div className="absolute bottom-40 left-1/4 w-1.5 h-1.5 bg-emerald-400 rounded-full animate-bounce opacity-40" style={{ animationDelay: '2s', animationDuration: '5s' }} />
      </div>
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-50 via-blue-50 via-emerald-50 to-teal-50 py-24 px-6 md:px-12 mb-20 shadow-2xl border border-white/20 backdrop-blur-sm">
        ...
        <div className="absolute -top-32 -right-32 w-[40rem] h-[40rem] bg-gradient-to-br from-green-300/30 to-emerald-400/20 blur-3xl rounded-full animate-pulse opacity-60" style={{ animationDuration: '4s' }} />
        <div className="absolute -bottom-40 -left-40 w-[45rem] h-[45rem] bg-gradient-to-tr from-blue-300/25 to-cyan-400/15 blur-3xl rounded-full animate-pulse opacity-50" style={{ animationDuration: '6s' }} />
        <div className="absolute top-1/2 right-1/4 w-64 h-64 bg-gradient-to-bl from-purple-300/20 to-pink-300/15 blur-2xl rounded-full animate-spin opacity-30" style={{ animationDuration: '20s' }} />
        
        {/* Floating geometric shapes */}
        <div className="absolute top-16 right-16 w-8 h-8 border-2 border-green-400/30 rounded-lg animate-spin opacity-60" style={{ animationDuration: '8s' }} />
        <div className="absolute bottom-20 left-20 w-6 h-6 border-2 border-blue-400/30 rounded-full animate-ping opacity-40" style={{ animationDuration: '3s' }} />
        ...
        <div className="relative grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-slideInLeft">
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/90 border border-green-200/50 text-sm shadow-lg backdrop-blur-md hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <span className="font-medium text-gray-700">{t('home_badge')}</span>
            ...
            <p className="text-xl text-gray-700 max-w-2xl leading-relaxed animate-fadeInUp font-medium" style={{ animationDelay: '0.2s' }}>
              {t('tagline')}
            </p>
            ...
            {/* Enhanced Stats */}
            <div className="grid grid-cols-3 gap-6 max-w-lg animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
              {[
                { value: '25k+', label: t('home_stat_farmers'), color: 'green', delay: '0.7s' },
                { value: '120+', label: t('home_stat_districts'), color: 'blue', delay: '0.8s' },
                { value: '4.8', label: t('home_stat_rating'), color: 'purple', delay: '0.9s' }
              ].map((stat, i) => (
                <div
                  key={i}
                ...
                >
                  <div className={`text-4xl font-black bg-gradient-to-br from-${stat.color}-600 to-${stat.color}-800 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300`}>
                    {stat.value}
                  </div>
                  <div className="text-sm font-semibold text-gray-600 mt-2">{stat.label}</div>
                  <div className={`w-full h-1 bg-gradient-to-r from-${stat.color}-400 to-${stat.color}-600 rounded-full mt-3 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500`} />
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="mb-20">
        <div className="text-center mb-16 animate-fadeInUp">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">{t('home_offers_sub')}</p>
        </div>
      ...
      <section className="mb-20 relative">
        ...
        <div className="relative p-12">
          <div className="text-center mb-16 animate-fadeInUp">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">{t('home_tech_sub')}</p>
          </div>
      ...
      <section className="mb-20">
        <div className="text-center mb-16 animate-fadeInUp">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">{t('home_goals_sub')}</p>
        </div>
      ...
      <section className="mb-24">
        <div className="relative animate-fadeInUp overflow-hidden">
          <Card className="relative shadow-2xl border-2 border-transparent bg-gradient-to-br from-white via-blue-50 to-green-50 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-blue-200/30 to-transparent rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }} />
            ...
            <div className="relative p-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-8">
                  {[
                    { num: 1, text: t('home_step_profile'), color: 'green', delay: '0.2s' },
                    { num: 2, text: t('home_step_field'), color: 'blue', delay: '0.4s' },
                    { num: 3, text: t('home_step_reco'), color: 'purple', delay: '0.6s' }
                  ].map((step, i) => (
                    <div
                      key={i}
                    ...
                    >
                      <div className={`relative w-12 h-12 bg-gradient-to-br from-${step.color}-400 to-${step.color}-600 rounded-full flex items-center justify-center font-black text-white shadow-lg group-hover:scale-125 group-hover:rotate-12 transition-all duration-300`}>
                        <span className="relative z-10">{step.num}</span>
                        <div className={`absolute inset-0 bg-${step.color}-300 rounded-full blur-md opacity-50 group-hover:opacity-75 transition-opacity duration-300`} />
                      </div>
